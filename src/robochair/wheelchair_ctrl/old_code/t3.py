...
class camera_wheelchair_teleop():
    ...
    def execute_trajectory(self):
        ...
        trajectory_steps = [
            # new trajectory
            {"type": "move_x", "distance": 1.2, "timeout": 50},
            {"type": "rotate", "angle": math.radians(63), "timeout": 50},
            {"type": "move_y", "distance": -2.23, "timeout": 50},  # Turn left 30 degrees, 3-second timeout
            {"type": "rotate", "angle": math.radians(95), "timeout": 50},
            {"type": "move_x", "distance": -0.875, "timeout": 50}, 
